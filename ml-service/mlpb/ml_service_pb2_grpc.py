...
class MLServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEmbedding = channel.unary_unary(
                '/ml.MLService/GetEmbedding',
                request_serializer=ml__service__pb2.ImageRequest.SerializeToString,
                response_deserializer=ml__service__pb2.EmbeddingResponse.FromString,
...
def add_MLServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetEmbedding': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=ml__service__pb2.EmbeddingResponse.SerializeToString,
            ),
    }
...
class MLService(object):
    ...
    def GetEmbedding(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            ml__service__pb2.EmbeddingResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
